...
class SQLCliente 
{
	...
	public long adicionarCliente (PersistenceManager pm, long documento, int numHab ) 
	{
		Query q = pm.newQuery(SQL, "INSERT INTO " + pp.darTablaCliente () + "(numero_documento, numero_habitacion) values (?, ?");
		q.setParameters(documento, numHab);
