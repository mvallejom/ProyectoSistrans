...
class SQLReservaHabitacion 
{
	...
	public long adicionarReservaHabitacion (PersistenceManager pm, long idReservaHabitacion, String fechaEtrada, String fechaSalida, int numPersonas, long docCliente,long idHotel) 
	{
